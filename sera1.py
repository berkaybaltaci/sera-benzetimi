...
def get():
    x = requests.get('https://smart-greenhouse-eeeb1-default-rtdb.firebaseio.com/istenen_sicaklik/-MQbYfmvGT9Vu1bxxgwY/temp.json') # endAt="1"
    #print(type(x))
...
def post(serialString):
        ...
        result = firebase.post('/sera1', new_sera, {'print': 'pretty'}, {'X_FANCY_HEADER': 'VERY FANCY'})
        print(result)
