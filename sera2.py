...
def get():
    x = requests.get('https://smart-greenhouse-eeeb1-default-rtdb.firebaseio.com/istenen_sicaklik/-MQb_mCgwR76f6XOa7Fx/temp.json') # endAt="2"
    #print(type(x))
...
def post(serialString):
        ...
        result = firebase.post('/sera2', new_sera, {'print': 'pretty'}, {'X_FANCY_HEADER': 'VERY FANCY'})
        print(result)
